class Settings:
    ...
    def __init__(self):
        ...
        self.bullets_allowed = 999  # 允许存在的子弹数量（无限制）
        ...
        # Power-up settings
        self.powerup_speed = 1.5  # 补给掉落速度
        self.powerup_width = 40  # 补给宽度
        self.powerup_height = 40  # 补给高度
        self.powerup_color = (0, 255, 0)  # 补给颜色 (绿色)
        self.powerup_spawn_interval = 15000  # 补给生成间隔 (毫秒)
        self.powerup_duration = 10000  # 补给效果持续时间 (毫秒)
        self.powerup_bullet_bonus = 2  # 补给增加的子弹数量
        self.powerup_bullet_width_bonus = 3  # 补给增加的子弹宽度
